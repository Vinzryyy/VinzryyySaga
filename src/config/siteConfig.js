...
export const SITE_CONFIG = {
  ...
  home: {
    hero: {
      ...
      backgrounds: [
        '/archive/img-002.webp',
        '/archive/img-044.webp',
        '/archive/img-046.webp',
        '/archive/img-083.webp',
        '/archive/img-084.webp',
        '/archive/img-087.webp',
        '/archive/img-088.webp',
        '/archive/img-094.webp',
        '/archive/img-128.webp',
        '/archive/img-192.webp',
        '/archive/img-205.webp',
      ],
