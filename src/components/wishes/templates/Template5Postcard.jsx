 ...
 * Cream postcard layout: top-right "stamp" box with date + apricot blossom,
 * dotted vertical divider down the middle, name top-left, message body,
 * burgundy edge border for the postcard frame.
 */
...
const Template5Postcard = ({ wish }) => {
  ...
  return (
    <article className="relative h-full min-h-[280px] flex flex-col rounded-md bg-[color:var(--retro-cream)] p-5 shadow-md border-2 border-[color:var(--retro-burgundy)]/30">
      ...
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        {/* Stamp box */}
        <div className="flex-shrink-0 w-16 h-20 border-2 border-dashed border-[color:var(--retro-burgundy)]/50 rounded flex flex-col items-center justify-center p-1 text-center bg-white/40">
