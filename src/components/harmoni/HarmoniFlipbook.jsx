...
const SPREADS = [
  ...
  {
    chapter: 'Venue',
    left:  { img: '/cgv/layout/cgv layout.webp',  caption: 'CGV FX Sudirman F7' },
    right: { img: '/cgv/layout/sts poster.webp',  caption: '' },
  },
  {
    chapter: 'Dinding Kebaikan',
    left:  { img: '/cgv/layout/dinding kebaikan.webp',   caption: '' },
    right: { img: '/cgv/layout/dinding kebaikan 2.webp', caption: '' },
  },
  {
    chapter: 'Apresiasi',
    left:  { img: '/cgv/layout/cgv top spender.webp', caption: '' },
    right: { img: '/cgv/layout/table.webp',           caption: '' },
  },
  {
    chapter: 'Ceu Eli',
    left:  { img: '/cgv/eli.webp',         caption: '' },
    right: { img: '/cgv/eliwithfans.webp', caption: '' },
  },
  {
    chapter: 'Komunitas',
    left:  { img: '/cgv/queen cemot.webp', caption: '' },
    right: { img: '/cgv/cemot.webp',       caption: '' },
  },
  {
    chapter: 'Kenangan',
    left:  { img: '/cgv/cangcorang.webp',     caption: '' },
    right: { img: '/cgv/armephotostrip.webp', caption: '' },
  },
  {
    chapter: 'Videotron',
