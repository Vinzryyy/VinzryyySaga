    ...
    >
      ...
      >
        {/* Image — picture element negotiates AVIF -> WebP -> JPG. Sources
            map to /public/archive/x/x-{mediaKey}.{avif,webp} variants
            generated by scripts/import-x-archive.js (idempotent; safe if
            files missing because the JPG <img> is the final fallback). */}
        <picture>
