    ...
    <main>
      ...
      <Section id="data" padding="xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          {/* Portrait close-up — object-position pinned to the top so
              faces in upper-frame photos don't get pushed out by the
              parallax. Parallax intensity halved so the image barely
              shifts on scroll, keeping the subject locked in view. */}
